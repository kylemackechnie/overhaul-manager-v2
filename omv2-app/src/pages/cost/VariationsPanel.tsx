      ...
      <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:'16px'}}>
        <div>
          <div style={{display:'flex',alignItems:'center',gap:'8px'}}>
            <h1 style={{fontSize:'18px',fontWeight:700,margin:0}}>Contract Variations</h1>
            <HelpButton panelId="variations" />
          </div>
                  ...
                  <div style={{display:'flex',gap:'4px'}} onClick={e=>e.stopPropagation()}>
                    ...
                    <button className="btn btn-sm" onClick={()=>{
                      ...
                      generateVariationDoc({
                        ...
                        lines: (variationLines.get(v.id)||[]).map(l=>({category:l.category,description:l.description,sell_total:l.sell_total})),
                ...
                {modal!=='new' && (
                  <button className="btn btn-sm" onClick={()=>{
                    ...
                    generateVariationDoc({
                      ...
                      raisedDate: fmtRaisedDate(v.raised_date),
                      validUntil: fmtValidUntil(v.valid_until),
                      lines: lines.filter(l=>l.description.trim()).map(l=>({category:l.category,description:l.description,sell_total:l.sell_total})),
                      client: activeProject!.client||'',
                      siemensProjectNo: si.siemens_project_no||'',
                      contractNo: si.contract_no||'',
                      unit: activeProject!.unit||'',
